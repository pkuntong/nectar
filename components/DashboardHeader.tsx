  ...
  return (
    <header className="flex justify-between items-center p-6 border-b border-dark-card-border">
      ...
      <div className="flex items-center space-x-6">
        <button 
          onClick={() => alert('Notifications:\n\n• New side hustle opportunities available\n• Weekly digest ready\n• Community update: 5 new success stories')}
          className="relative text-medium-text hover:text-light-text transition-colors"
        >
